...
---
Metrics for the other properties can be found in the respective logs in the **logfiles** directory
...
because of the size of the pretrained models, they are hosted on huggingface and should be downloaded from the link below and put in **models** folder
